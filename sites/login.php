          ...
          <div class="row" role="banner">
            <div class="span12">
              <div class="html5-header portal-header">
                <div class="html5-figure main-image"> <a href="#" title="Link fŸhrt zur Startseite von Berlin.de">
                    <img class="portal-logo hide-mobile" src="../assets/bootstrap/css/images/berlin_de.png"
                      alt="Bild zeigt: Berlin.de Logo"
                      title="Link fŸhrt zur Startseite von Berlin.de">
                  </a> </div>
              </div>
            </div>
          </div>
          ...
          <div class="row html5-header content-header" role="banner">
            <div class="span5">
              <div class="html5-section section-logo without-logo">
                <div class="html5-section text"> <a href="./index.php" title="Link fŸhrt zur Startseite von 'Institution Titel der Institution'">
...
mysql_select_db("zeiterfassungsbogen") or die ("Datenbank konnte nicht ausgew&auml;hlt werden");
...
if($row->passwort == $passwort)
    ...
    echo '<meta http-equiv="refresh" content="5; url=geheim.php">';
    }
else
    {
